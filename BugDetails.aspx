<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BugDetails.aspx.cs" Inherits="BugDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="style5" align="center">
        ...
        <tr>
            <td class="style11" colspan="5" align="center">&nbsp;View/Edit Bug Details</td>
        </tr>
        ...
        <tr>
            <td colspan="5" align="center">
                <asp:Button ID="Button1" runat="server" Text="Save" class="button style7" />
