        ...
        <ContentTemplate>
            ...
            <table align="center" class="style5">
                    ...
                    <caption>
                        ...
                        <tr>
                            ...
                            <td align="center" class="text" width="10%">
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                    <ContentTemplate>
                                        <br />
                                        <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="False" ImageUrl="~/Image/Calendar.gif" OnClick="ImageButton1_Click" />
                        ...
                        <tr>
                            ...
                            <td align="center" class="text" width="10%">
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>
                                        <br />
                                        <asp:ImageButton ID="ImageButton2" runat="server" CausesValidation="False" ImageUrl="~/Image/Calendar.gif" OnClick="ImageButton2_Click" />
                                        <asp:Calendar ID="Calendar1" runat="server" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" CellPadding="1" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="#003399" Height="200px" Visible="False" Width="220px" OnSelectionChanged="Calendar1_SelectionChanged">
                                            <DayHeaderStyle BackColor="#99CCCC" ForeColor="#336666" Height="1px" />
                                            <NextPrevStyle Font-Size="8pt" ForeColor="#CCCCFF" />
                                            <OtherMonthDayStyle ForeColor="#999999" />
                                            <SelectedDayStyle BackColor="#009999" Font-Bold="True" ForeColor="#CCFF99" />
                        ...
                        <tr>
                            ...
                            <td align="center" class="text" width="20%">
                                <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem class="style7" Selected="True" Value="Employee" Text="Employee">Employee&nbsp;&nbsp;</asp:ListItem>
                                    <asp:ListItem class="style7" Text="Admin">Admin</asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                        ...
                        <tr>
                            <td align ="center" colspan="6" class="auto-style9">
                        ...
                        <tr>
                            <td align="center" class="text" colspan="6">
                                <asp:Button ID="submit" runat="server" CssClass="button style7" Text="Submit" OnClick="submit_Click" />
                                <asp:Button ID="cancel" runat="server" CausesValidation="false" CssClass="button style7" Text="Cancel" />
                                <asp:Button ID="reset" runat="server" CausesValidation="false" CssClass="button style7" Text="Reset" OnClick="reset_Click" />
                            </td>
                        </tr>
                    </caption>
            </table>
